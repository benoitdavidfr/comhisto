...
/*PhpDoc:
name: fetat.php
title: fetat.php - fabrication du fichier com20200101.yaml à partir du fichier ../data/communes2020.csv
doc: |
...
if (php_sapi_name() == 'cli') {
  ...
  echo "<!DOCTYPE HTML><html><head><meta charset='UTF-8'><title>fetat</title></head><body>\n",
...
echo Yaml::dump([
    ...
    'valid'=> $params['valid'],
    'source'=> "création par traduction du fichier $params[file] de l'INSEE en utilisant la commande 'fetat.php ".implode(' ', $params)."'",
