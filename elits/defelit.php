...
class Version {
  ...
  function __construct(string $cinsee, string $debut, array $version) {
    ...
    $this->elts = new EltSet($version['elits0'] ?? '');
    //print_r($version);
  }
...
$histelts = Yaml::parsefile('histelit0.yaml');
...
foreach ($histelts['contents'] as $cinsee => &$histo) {
  foreach ($histo as $dv => &$version) {
    if (isset($version['elits0'])) {
      $eltSet = new EltSet($version['elits0']);
      unset($version['elits0']);
      $version['elits'] = $eltSet->ajouts($ajouts)->asArray();
    }
  }
}
...
$histelts['contents'][27528]['1943-01-01']['elits'] = [27528, 27701];
$histelts['contents'][27528]['1969-04-15']['elits'] = [27443, 27528, 27701];
$histelts['contents'][27528]['1981-09-28']['elits'] = [27443, 27528];

// 97306/97361
$histelts['contents'][97306]['1943-01-01']['elits'] = [97306, 97361];
$histelts['contents'][97306]['1969-03-27']['elits'] = [97306, 97355, 97361];
$histelts['contents'][97306]['1989-01-01']['elits'] = [97306, 97355];
...
$histelts['@id'] = "http://id.georef.eu/comhisto/zones/histelit";
...
$histelts['$schema'] = 'http://id.georef.eu/comhisto/insee/exhisto/$schema';
