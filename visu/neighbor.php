<?php
// génère une FeatureCollection GeoJSON des communes voisines de $_GET['id'], valides
// et soit de type s soit de type r non propre
//
...
$sql = "select n.cinsee, n.type, n.dnom, ST_AsGeoJSON(n.geom) geom
        ...
        where ST_MaxDistance(n.geom, c.geom) < 1
